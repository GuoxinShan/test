...
public class Mentor {
	...
	public Mentor(long id, String username, String courseId, String courseName, Date mentorStartDate, double totalRate, int numOfMentee) {
		super();
		this.id = id;
		...
		this.numberOfMentee=numOfMentee;
	}
	...
	public double getRate() {
		if(numberOfMentee!=0) {
			return totalRate/numberOfMentee;
		}
		return totalRate;
	}
	...
	public int getNumOfMentee() {
		return numberOfMentee;
	}

	//method to increase number of mentee taught by 1
	public void addNumOfMentee() {
		this.numberOfMentee++;
	}
