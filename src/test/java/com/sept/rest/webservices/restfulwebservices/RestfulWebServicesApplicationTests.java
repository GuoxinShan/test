...
import com.sept.rest.webservices.restfulwebservices.courses.*;
...
public class RestfulWebServicesApplicationTests 
{
	...
	public void init() 
	{
	     mentor = new Mentor (1,"SEPT","COSC123","Software Engineering",new Date(2019,03,03),20.00,5);
	     course = new courses(1,"SEPT","COSC123","Software Engineering",false,100);
	     mentee = new Mentee (1,"SEPT","COSC123","Software Engineering",new Date(2019,04,04),1,"Mr.Mentor","mentor@gmail.com",false);
	     group = new StudyGroup (1,"SEPT","COSC123","Software Engineering","Group 1",new Date(2019,05,05));
	}
	...
	{
		assertEquals(mentee.getMentorDate(),new Date(2019,04,04));
	}
	
	@Test
	public void menteeSetMentorDateTest() 
	{
	    mentee.setMentorDate(new Date(2019,04,05));
	    assertEquals(mentee.getMentorDate(),new Date(2019,04,05));
	}
	...
	{
		assertEquals(mentor.getMentorStartDate(),new Date(2019,03,03));
	}
	
	@Test
	public void mentorSetStartDateTest() 
	{
	    mentor.setMentorStartDate(new Date(2019,07,07));
	    assertEquals(mentor.getMentorStartDate(),new Date(2019,07,07));
	}
	...
	{
		assertEquals(mentor.getNumOfMentee(),5);
	}
	
	@Test
	public void mentorAddNumOfMenteeTest() 
	{
	    mentor.addNumOfMentee();
	    assertEquals(mentor.getNumOfMentee(),6);
	}
